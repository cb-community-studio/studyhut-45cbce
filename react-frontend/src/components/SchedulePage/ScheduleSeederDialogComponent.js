...
import seederData from "./schedule.seeder.json";
...
const ScheduleSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(ScheduleSeederDialogComponent);
