...
import seederData from "./userinfo.seeder.json";
...
const UserinfoSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(UserinfoSeederDialogComponent);
