...
const HomeworkCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        setLoading(true);
        try {
            const result = await client.service("homework").patch(_entity._id, _data);
            props.onHide();
    ...
    return (
        <Dialog header="Edit Info" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="homework-edit-dialog-component">
                <div>
                ...
                <div>
                    ...
                    <InputText type="number" className="w-full mb-3" value={_entity?.priority} onChange={(e) => setValByKey("priority", e.target.value)}  />
                </div>
                <div>
...
export default connect(null, mapDispatch)(HomeworkCreateDialogComponent);
