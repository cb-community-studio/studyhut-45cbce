...
import seederData from "./homework.seeder.json";
...
const HomeworkSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(HomeworkSeederDialogComponent);
